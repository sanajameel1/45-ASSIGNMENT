...
// const magicians2: string[] = ["usman", "haseem", "wajahat",];
// make_great(magicians2)
// show_magicians(magicians2)


// TASK 43
// function make_great2(mogicions: String[]): string[] {
//   const greatMagicians: string[] = [];
//   for (let 1 = 0; 1 < mogicions.length; i++){
//       greatMagicians.push(mogicions[i] + 'the great');
//   }
...
//   }
// }
// console.log("enjoy your sandwich sana jameel")
